...
const en = {
  ...
  omniboxPlaceholder: 'Search, or paste a GitHub URL to save…',
  repoDetected: 'GitHub repository detected:',
  saveIt: 'Save',
  savedOpen: 'Saved — open it',
  alreadySaved: 'Already in your library',
  openIt: 'Open',
  savingIn: 'Saving…',
  filters: 'Filters',
  backToList: '← Back to list',
  statusbarHint: 'Esc to go back · Ctrl+Alt+K to summon',
  aiSummary: 'AI summary',
  aiGenerate: 'Generate summary',
  aiRegenerate: 'Regenerate',
  aiWorking: 'Summarizing…',
  aiDisclaimer: 'AI-generated, never overwrites your own notes.',
  aiNotConfigured: 'Set your DeepSeek API key in Settings first.',
  importBookmarks: 'Import Chrome bookmarks',
  importBookmarksHelp: 'Reads your Chrome bookmarks file (read-only) and imports GitHub repositories found there.',
  orDivider: 'or',
  settingsDeepseekKey: 'DeepSeek API key (optional)',
  settingsDeepseekHelp: 'Used for AI summaries of repositories. Stored only in the local data directory, never exported.',
  settingsDeepseekSet: 'A DeepSeek key is stored.',
  settingsDeepseekUnset: 'No DeepSeek key stored.',
  settingsTokenPlaceholderShort: 'sk-…',
  field_name: 'name',
  field_owner: 'owner',
...
const zhCN = {
  ...
  omniboxPlaceholder: '搜索，或粘贴 GitHub URL 收藏…',
  repoDetected: '检测到 GitHub 仓库：',
  saveIt: '收藏',
  savedOpen: '已收藏——打开',
  alreadySaved: '已在库中',
  openIt: '打开',
  ...
  filters: '筛选',
  backToList: '← 返回列表',
  statusbarHint: 'Esc 返回 · Ctrl+Alt+K 唤起',
  aiSummary: 'AI 总结',
  aiGenerate: '生成总结',
  aiRegenerate: '重新生成',
  aiWorking: '正在总结…',
  aiDisclaimer: 'AI 生成，永远不会覆盖你自己的笔记。',
  aiNotConfigured: '请先在设置中配置 DeepSeek API Key。',
  importBookmarks: '从 Chrome 收藏夹导入',
  importBookmarksHelp: '只读地读取 Chrome 收藏夹文件，导入其中的 GitHub 仓库。',
  orDivider: '或',
  settingsDeepseekKey: 'DeepSeek API Key（可选）',
  settingsDeepseekHelp: '用于仓库的 AI 总结。只保存在本地数据目录，不会被导出。',
  settingsDeepseekSet: '已保存 DeepSeek 密钥。',
  settingsDeepseekUnset: '未保存 DeepSeek 密钥。',
  settingsTokenPlaceholderShort: 'sk-…',
  field_name: '名称',
  field_owner: '所有者',
